				...
				Results: []AuthenticationResult{
					{
						Method:     "spf",
						Result:     "pass",
						Properties: []Property{Property{"smtp", "mailfrom", "example.net"}},
					},
				},
			},
		},
				...
				Results: []AuthenticationResult{
					{
						Method:     "iprev",
						Result:     "pass",
						Properties: []Property{Property{"policy", "iprev", "127.0.0.1"}},
					},
				},
			},
		},
				...
				Results: []AuthenticationResult{
					{
						Method:     "dkim",
						Result:     "pass",
						Properties: []Property{Property{"header", "d", "mail-router.example.net"}},
					},
					{
						Method:     "dkim",
						Result:     "fail",
						Properties: []Property{Property{"header", "d", "newyork.example.com"}},
					},
				},
			},
		},
				...
				Results: []AuthenticationResult{
					{
						...
						Version:    "1",
						Result:     "fail",
						Properties: []Property{Property{"policy", "expired", "1362471462"}},
					},
				},
			},
		},
